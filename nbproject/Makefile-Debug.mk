...
${OBJECTDIR}/AssemblyAddress.o: AssemblyAddress.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssemblyAddress.o AssemblyAddress.cpp

${OBJECTDIR}/AssemblyFunction.o: AssemblyFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssemblyFunction.o AssemblyFunction.cpp

${OBJECTDIR}/AssemblyInstruction.o: AssemblyInstruction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssemblyInstruction.o AssemblyInstruction.cpp

${OBJECTDIR}/AssemblyLibrary.o: AssemblyLibrary.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssemblyLibrary.o AssemblyLibrary.cpp

${OBJECTDIR}/AssemblyStatement.o: AssemblyStatement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssemblyStatement.o AssemblyStatement.cpp

${OBJECTDIR}/ExpressionNode.o: ExpressionNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExpressionNode.o ExpressionNode.cpp

${OBJECTDIR}/ExpressionTree.o: ExpressionTree.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExpressionTree.o ExpressionTree.cpp
...
${OBJECTDIR}/NimbleFunction.o: NimbleFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NimbleFunction.o NimbleFunction.cpp

${OBJECTDIR}/NimbleLibrary.o: NimbleLibrary.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NimbleLibrary.o NimbleLibrary.cpp

${OBJECTDIR}/NimbleSyntax.o: NimbleSyntax.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NimbleSyntax.o NimbleSyntax.cpp

${OBJECTDIR}/NimbleTest.o: NimbleTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NimbleTest.o NimbleTest.cpp

${OBJECTDIR}/ParseBlock.o: ParseBlock.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseBlock.o ParseBlock.cpp

${OBJECTDIR}/ParseNode.o: ParseNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseNode.o ParseNode.cpp

${OBJECTDIR}/ParseTree.o: ParseTree.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseTree.o ParseTree.cpp
...
${OBJECTDIR}/SyntaxParseBlock.o: SyntaxParseBlock.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SyntaxParseBlock.o SyntaxParseBlock.cpp

${OBJECTDIR}/SyntaxParser.o: SyntaxParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SyntaxParser.o SyntaxParser.cpp
